...
public class EncodeDecode
{
  ...
  public static String ReturnBasicAuth() {
		// TODO Auto-generated method stub
	  
	  
	  String s= encodeUTF8("YrfBeTHrMUCuSD4kdAMBF69WX");
	  System.out.println(s);
	  String s2=encodeUTF8("10Xbelb6ftIsnqNVvukPI1BwbL9nn2QnoX0QheetSYo0t32hJ8");
	  System.out.println(s2);
	  String s3 =s+":"+s2;
	  
	  
	  String FinalString="Basic "+base64Encode(s3);
